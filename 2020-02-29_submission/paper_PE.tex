...
%	\item for MBHBs with $h_{22}$ only: $\sim 300$ grid points, likelihood cost $\sim 1.2\mathrm{ms}$;
%	\item for MBHBs with 5 modes: $\sim 300$ grid points, likelihood cost $\sim 15\mathrm{ms}$.
%\end{itemize}
...
%      \includegraphics[width=.99\linewidth]{t-of-F.pdf}
%   \end{minipage}
%   \begin{minipage}{.48\linewidth}
%      \includegraphics[width=.99\linewidth]{t-of-SNR.pdf}
%   \end{minipage}
...
%The TDI channel $T$, negligible as well for low-frequency MBHB signals, makes here a small contribution at high frequencies.
...
%\begin{figure}
%  \centering
%  \includegraphics[width=.99\linewidth]{plot_MM_ROM.pdf}
...
%  \centering
%  \begin{minipage}{.32\linewidth}
%      \includegraphics[width=.99\linewidth]{corner_smbh_case9_hm_dseries_m1m2.png}
%   \end{minipage}
%   \begin{minipage}{.32\linewidth}
%      \includegraphics[width=.99\linewidth]{corner_smbh_case9_hm_dseries_Dinc.png}
%   \end{minipage}
%   \begin{minipage}{.32\linewidth}
%      \includegraphics[width=.99\linewidth]{corner_smbh_case9_hm_dseries_tphi.png}
%   \end{minipage}
%  \caption{.}
%  \label{fig:smbhCornerZoomHMCase9}
%\end{figure*}
...
%\begin{figure*}
%  \centering
%  \includegraphics[width=.8\linewidth]{plot_mollweide_dseries.png}
%  \caption{.}
