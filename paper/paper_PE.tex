...
Therefore, we expect that the cost can be reduced even further with future optimizations.
...
and \ref{fig:sbhb_corner_12}. Similarly to the MBHB systems, we find close agreement between the \texttt{multinest} and
