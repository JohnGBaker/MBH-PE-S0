...
\begin{align}
	\tilde{a}, \tilde{e} &= \frac{e^{-2i\pi fL}}{i \sqrt{2} \sin (2\pi f L)}\times \tilde{A}, \tilde{E} \,,\\
	\tilde{t} &= \frac{e^{-3i\pi fL}}{2\sqrt{2}  \sin (\pi f L) \sin (2\pi f L)} \times \tilde{T} \,.
\end{align}
\esub
