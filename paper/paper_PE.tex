...
LISA will be awesome.

Literature review on BBH PE (can base on GOAT study).

Main points of study:
\begin{itemize}
    \item Fast likelihood calculation of mergers, including ROM model with FD LISA response and techniques for fast overlaps.
    \item Example cases of MBH near sweet spot and SOBH.
    \item Compare Bayesian and Fisher.
    \item Study effect of higher modes for MBH.
    \item Evolution of information over time to merger.
    \item Analytic intuitive explanation of complicated degeneracies.
\end{itemize}
